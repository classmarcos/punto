                ...
                <div class="row mt">
                    ...
                    <div class="col-md-3 col-sm-3 mb">
                        <div class="white-panel pn">
                            ...
                            <div class="centered">
                                <a href="javascript:void(0)" class="btn btn-default btn-xs" onclick="mostrar('','<?php echo base_url(); ?>clientes/buscarcliente','#resultado')"><img src="assets/img/monei.png" width="120"></a>
                            </div>
                        </div>
                    </div><!-- /col-md-4 -->
